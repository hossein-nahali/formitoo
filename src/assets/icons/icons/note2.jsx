export const Note2 = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" {...props}>
        <path
            ...
            stroke={props.color ? props.color : "#343434"} strokeWidth="1.5" strokeLinecap="round"
        ...
        <path
            ...
            stroke={props.color ? props.color : "#343434"} strokeWidth="1.5" strokeLinecap="round"
            strokeLinejoin="round"/>
        <path d="M12.6396 8.53003L17.4896 9.76003" stroke={props.color ? props.color : "#343434"} strokeWidth="1.5"
              strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M11.6602 12.3999L14.5602 13.1399" stroke={props.color ? props.color : "#343434"} strokeWidth="1.5"
              strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
)
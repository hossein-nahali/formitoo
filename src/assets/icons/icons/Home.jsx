export const Home = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path
            ...
            stroke={props.color ? props.color : "#899EA9"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M12 17.99V14.99" stroke={props.color ? props.color : "#899EA9"} strokeWidth="1.5" strokeLinecap="round"

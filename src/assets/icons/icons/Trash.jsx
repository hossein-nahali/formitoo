export const Trash = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <path
            ...
            stroke={props.color ? props.color : "#292D32"} strokeWidth="1.5" strokeLinecap="round"
            strokeLinejoin="round"/>
        <path d="M10.3301 16.5H13.6601" stroke={props.color ? props.color : "#292D32"} strokeWidth="1.5"
              strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M9.5 12.5H14.5" stroke={props.color ? props.color : "#292D32"} strokeWidth="1.5" strokeLinecap="round"
              strokeLinejoin="round"/>
    </svg>
)